...
function Herosection(){
    return(
        <div className="h-auto md:[40rem] w-full mt-80 rounded-md flex flex-col items-center justify-center
        relative  mx-auto py-10 md:py-0 ">
            ...
            />
                ...
                >Dive iinto our comprehensive music courses and 
                    transform your musical journey today . Whealther 
                    you're a begginer or looking to refine your 
